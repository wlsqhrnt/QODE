...
int ball_Y_limitSwitch1 = 40;//적외선 센서 
int ball_Y_limitSwitch2 = 41;//적외선 센서 
//A_racket variable
char A_X_dir = 0;
int A_X_stpPin = 6;
int A_X_dirPin = 7;
...
{
    Timer1.attachInterrupt(ball_X_timerHandler).start(10);
    Timer2.attachInterrupt(ball_Y_timerHandler).start(10);
    Timer3.attachInterrupt(A_X_timerHandler).start(10);
    Timer4.attachInterrupt(B_X_timerHandler).start(10); //10us
