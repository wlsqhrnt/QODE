...
void A_Collision_check(){
    if(ball_X_Cood < A_X_Cood){//라켓의 왼쪽
        if(A_X_Cood - 5 <= ball_X_Cood && ball_X_Cood <= A_X_Cood){//90
            ...
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood - 57 <= ball_X_Cood && ball_X_Cood <= A_X_Cood - 44){//40
            angle = 140;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood - 70 <= ball_X_Cood && ball_X_Cood <= A_X_Cood - 57){//40
            angle = 140;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood - 106 <= ball_X_Cood && ball_X_Cood <= A_X_Cood - 70){//40
            angle = 140;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        ...
        if(A_X_Cood <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 5){//90
            ...
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood + 44 <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 57){//40
            angle = 40;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood + 57 <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 70){//40
            angle = 40;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood + 70 <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 106){//40
            angle = 40;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
...
void B_Collision_check(){
    if(ball_X_Cood < B_X_Cood){
        if(B_X_Cood - 5 <= ball_X_Cood && ball_X_Cood <= B_X_Cood){//90
            ...
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood - 57 <= ball_X_Cood && ball_X_Cood <= B_X_Cood - 44){//40
            angle = 220;
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood - 70 <= ball_X_Cood && ball_X_Cood <= B_X_Cood - 57){//40
            angle = 220;
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood - 106 <= ball_X_Cood && ball_X_Cood <= B_X_Cood - 70){//40
            angle = 220;
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        ...
        if(B_X_Cood <= ball_X_Cood && ball_X_Cood <= B_X_Cood + 5){//90
            ...
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood + 44 <= ball_X_Cood && ball_X_Cood <= B_X_Cood + 57){//40
            angle = 320;
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
