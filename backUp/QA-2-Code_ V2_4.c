        ...
        if(item == 2){ // tornado
            if(ball_Y_dir == 0){
                if(ball_X_Cood < 278){
                    ...
                    if(ball_Y_Cood >= 500 && tornadoCheck == 2){//휘기 시작
                ...
                if(ball_X_Cood < 278){ 
                    ...
                    if(ball_Y_Cood <= 573 && tornadoCheck == 2){//휘기 시작
...
void A_Collision_check(){
    if(ball_X_Cood < A_X_Cood){//라켓의 왼쪽
        if(A_X_Cood - 5 <= ball_X_Cood && ball_X_Cood <= A_X_Cood){//4번
            angle = 90;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood - 18 <= ball_X_Cood && ball_X_Cood <= A_X_Cood - 5){//3번
            angle = 110;//70
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood - 31 <= ball_X_Cood && ball_X_Cood <= A_X_Cood - 18){//2번
            angle = 120;//60
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood - 44 <= ball_X_Cood && ball_X_Cood <= A_X_Cood - 31){//1번
            angle = 130;//50
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood - 57 <= ball_X_Cood && ball_X_Cood <= A_X_Cood - 44){//1번
            angle = 140;//40
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood - 70 <= ball_X_Cood && ball_X_Cood <= A_X_Cood - 57){//1번
            angle = 140;//40
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(ball_X_Cood >= A_X_Cood - 106){
            angle = 140;//40
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        ...
        if(A_X_Cood <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 5){//4번
            angle = 90;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood + 5 <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 18){//5번
            angle = 70;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood + 18 <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 31){//6번
            angle = 60;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood + 31 <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 44){//7번
            angle = 50;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood + 44 <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 57){//7번
            angle = 40;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
        }else if(A_X_Cood + 57 <= ball_X_Cood && ball_X_Cood <= A_X_Cood + 70){//7번
            angle = 40;
            setAngle(angle,speed);
            collision_check2 = 0;
            A_return = 1;
...
void B_Collision_check(){
    if(ball_X_Cood < B_X_Cood){
        if(B_X_Cood - 5 <= ball_X_Cood && ball_X_Cood <= B_X_Cood){//4번
            angle = 270;//90
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood - 18 <= ball_X_Cood && ball_X_Cood <= B_X_Cood -5){//5번
            angle = 250;//70
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood - 31 <= ball_X_Cood && ball_X_Cood <= B_X_Cood -18){//6번
            angle = 240;//60
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood - 44 <= ball_X_Cood && ball_X_Cood <= B_X_Cood -31){//7번
            angle = 230;//50
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood - 57 <= ball_X_Cood && ball_X_Cood <= B_X_Cood -44){//7번
            angle = 220;//40
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood - 70 <= ball_X_Cood && ball_X_Cood <= B_X_Cood -57){//7번
            angle = 220;//40
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(ball_X_Cood >= B_X_Cood - 106){//7번
            angle =220;
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        ...
        if(B_X_Cood <= ball_X_Cood && ball_X_Cood <= B_X_Cood + 5){//4번
            angle = 270;//90
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood + 5 <= ball_X_Cood && ball_X_Cood <= B_X_Cood + 18){//3번
            angle = 290;//70
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood + 18 <= ball_X_Cood && ball_X_Cood <= B_X_Cood + 31){//2번
            angle = 300;//60
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood + 31 <= ball_X_Cood && ball_X_Cood <= B_X_Cood + 44){//1번
            angle = 310;//50
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood + 44 <= ball_X_Cood && ball_X_Cood <= B_X_Cood + 57){//1번
            angle = 320;//40
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(B_X_Cood + 57 <= ball_X_Cood && ball_X_Cood <= B_X_Cood + 70){//1번
            angle = 320;//40
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
        }else if(ball_X_Cood <= B_X_Cood + 106){//1번
            angle = 320;
            setAngle(angle,speed);
            collision_check2 = 0;
            B_return = 1;
