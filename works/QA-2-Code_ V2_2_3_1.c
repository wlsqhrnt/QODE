...
void serialEvent2(){
    if((A_bluetooth_data = Serial2.read()) != -1){ //스마트폰 -> 아두이노 -> PC
        switch(A_bluetooth_data){
            ...
            case 'T' : A_use_mine_1 = 1;//라켓 A 지뢰 1위치 사용
      case 'U' :A_use_mine_2 = 1;//라켓 A 지뢰 2위치 사용
      case 'V' :A_use_mine_3 = 1;//라켓 A 지뢰 3위치 사용
      case 'W' :A_use_defender_1 = 1;//라켓 A 수비수 1위치 사용
      case 'X' :A_use_defender_2 = 1;//라켓 A 수비수 2위치 사용
      case 'Y' :A_use_defender_3 = 1;//라켓 A 수비수 3위치 사용
...
void serialEvent3(){
    if((B_bluetooth_data = Serial3.read()) != -1){ //스마트폰 -> 아두이노 -> PC
        switch(B_bluetooth_data){
            ...
            case 'T' : B_use_mine_1 = 1;//라켓 B 지뢰 1위치 사용
            case 'U' :B_use_mine_2 = 1;//라켓 B 지뢰 2위치 사용
            case 'V' :B_use_mine_3 = 1;//라켓 B 지뢰 3위치 사용
            case 'W' :B_use_defender_1 = 1;//라켓 B 수비수 1위치 사용
            case 'X' :B_use_defender_2 = 1;//라켓 B 수비수 2위치 사용
            case 'Y' :B_use_defender_3 = 1;//라켓 B 수비수 3위치 사용
